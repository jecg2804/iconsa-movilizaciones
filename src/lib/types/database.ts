...
export type Database = {
  ...
  public: {
    Tables: {
      ...
      trip_events: {
        Row: { attachments: Json | null; confirmation_code_used: string | null; created_at: string | null; event_timestamp: string | null; event_type: string; id: string; location: string | null; notes: string | null; received_by_id: string | null; received_by_name: string | null; registered_by: string | null; trip_id: string }
        Insert: { attachments?: Json | null; confirmation_code_used?: string | null; created_at?: string | null; event_timestamp?: string | null; event_type: string; id?: string; location?: string | null; notes?: string | null; received_by_id?: string | null; received_by_name?: string | null; registered_by?: string | null; trip_id: string }
        Update: { attachments?: Json | null; confirmation_code_used?: string | null; created_at?: string | null; event_timestamp?: string | null; event_type?: string; id?: string; location?: string | null; notes?: string | null; received_by_id?: string | null; received_by_name?: string | null; registered_by?: string | null; trip_id?: string }
        Relationships: []
      }
