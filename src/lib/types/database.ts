...
// 19 tables. Includes: project_extras, extra_id, created_by/updated_by, initial_priority, scheduled_time
// Place in: src/lib/types/database.ts
// IMPORTANT: This replaces the previous version completely.
...
export type Database = {
  ...
  public: {
    Tables: {
      ...
      sm_request_lines: {
        Row: { category: string | null; cost_category_id: string | null; cost_code_id: string | null; created_at: string | null; description: string; equipment_id: string | null; equipment_text: string | null; from_location_id: string | null; from_text: string | null; id: string; line_number: number; line_type: string; material_category: string | null; notes: string | null; po_reference: string | null; qty_delivered: number | null; qty_scheduled: number | null; quantity: number; request_id: string; status: string; to_location_id: string | null; to_text: string | null; unit_id: string | null; unit_text: string | null; updated_at: string | null; updated_by: string | null }
        Insert: { category?: string | null; cost_category_id?: string | null; cost_code_id?: string | null; created_at?: string | null; description: string; equipment_id?: string | null; equipment_text?: string | null; from_location_id?: string | null; from_text?: string | null; id?: string; line_number: number; line_type: string; material_category?: string | null; notes?: string | null; po_reference?: string | null; qty_delivered?: number | null; qty_scheduled?: number | null; quantity?: number; request_id: string; status?: string; to_location_id?: string | null; to_text?: string | null; unit_id?: string | null; unit_text?: string | null; updated_at?: string | null; updated_by?: string | null }
        Update: { category?: string | null; cost_category_id?: string | null; cost_code_id?: string | null; created_at?: string | null; description?: string; equipment_id?: string | null; equipment_text?: string | null; from_location_id?: string | null; from_text?: string | null; id?: string; line_number?: number; line_type?: string; material_category?: string | null; notes?: string | null; po_reference?: string | null; qty_delivered?: number | null; qty_scheduled?: number | null; quantity?: number; request_id?: string; status?: string; to_location_id?: string | null; to_text?: string | null; unit_id?: string | null; unit_text?: string | null; updated_at?: string | null; updated_by?: string | null }
        Relationships: []
      }
      sm_requests: {
        Row: { approved_by: string | null; attachments: Json | null; created_at: string | null; created_by: string | null; date_created: string | null; date_required: string; id: string; initial_priority: string | null; notes: string | null; priority: string | null; project_id: string; request_id: string | null; requester_id: string; status: string; updated_at: string | null; updated_by: string | null }
        Insert: { approved_by?: string | null; attachments?: Json | null; created_at?: string | null; created_by?: string | null; date_created?: string | null; date_required: string; id?: string; initial_priority?: string | null; notes?: string | null; priority?: string | null; project_id: string; request_id?: string | null; requester_id: string; status?: string; updated_at?: string | null; updated_by?: string | null }
        Update: { approved_by?: string | null; attachments?: Json | null; created_at?: string | null; created_by?: string | null; date_created?: string | null; date_required?: string; id?: string; initial_priority?: string | null; notes?: string | null; priority?: string | null; project_id?: string; request_id?: string | null; requester_id?: string; status?: string; updated_at?: string | null; updated_by?: string | null }
        Relationships: []
      }
      suggestions: {
      ...
      trips: {
        Row: { actual_arrival: string | null; actual_departure: string | null; att_permit: boolean | null; confirmation_code: string | null; cost: number | null; created_at: string | null; created_by: string | null; driver_id: string | null; escort: boolean | null; id: string; is_external: boolean | null; notes: string | null; rate_id: string | null; route_summary: string | null; scheduled_date: string; scheduled_time: string | null; status: string; trailer_id: string | null; trip_id: string | null; updated_at: string | null; updated_by: string | null; vehicle_id: string | null }
